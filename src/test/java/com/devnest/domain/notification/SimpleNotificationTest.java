package com.devnest.domain.notification;
...
public class SimpleNotificationTest {
    ...
    public void testPackageStructure() {
        ...
        // 클래스 로딩 테스트
        try {
            Class<?> notificationClass = Class.forName("com.devnest.domain.notification.entity.Notification");
            Class<?> notificationTypeClass = Class.forName("com.devnest.domain.notification.entity.NotificationType");
            Class<?> controllerClass = Class
                    .forName("com.devnest.domain.notification.controller.NotificationController");
            Class<?> serviceClass = Class.forName("com.devnest.domain.notification.service.NotificationService");
            Class<?> repositoryClass = Class
                    .forName("com.devnest.domain.notification.repository.NotificationRepository");
